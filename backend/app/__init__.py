...
def create_app():
    ...
    app.register_blueprint(retry_policy_bp, url_prefix="/api/retry-policies")
    app.register_blueprint(scheduled_job_bp, url_prefix="/api/scheduled-jobs")
    app.register_blueprint(job_execution_bp, url_prefix="/api/job-executions")
    app.register_blueprint(dead_letter_bp, url_prefix="/api/dead-letters")
